...
insert  into `blog_post`(`id`,`author_id`,`content`,`summary`,`tags`,`status`,`created`,`updated`,`rep_image`,`featured`,`views`,`rate`,`rate_count`,`cmt_count`,`allow_rate`,`allow_cmt`,`category_id`,`title`) values (1,1,'This blog system is developed using Yii. It is meant to demonstrate how to use Yii to build a complete real-world application. Complete source code may be found in the Yii releases.\n\nFeel free to try this system by writing new posts and posting comments.','This blog system is developed using Yii. It is meant to demonstrate how to use Yii to build a complete real-world application. Complete source code may be found in the Yii releases.','yii, blog',2,1230952187,1230952187,NULL,0,0,0,0,0,1,1,0,'Welcome!'),(72,1,'<p>sdfsadgdfgdf<br /></p>','sdfdfgdfg','',1,1370623143,1370623143,NULL,0,0,0,0,0,1,1,9,'sdfsdf'),(75,1,'<p>sdfsdg<br /></p>','sdgdfg','',1,1372265241,1372265241,NULL,0,0,0,0,0,1,1,32,'dsfsf'),(76,3,'<p>风吹屁屁凉<br /></p>','撒旦法撒旦个大发光火','',1,1372265356,1372265356,NULL,0,0,0,0,0,1,1,12,'屁屁凉'),(3,1,'最新更新我的博客，新版感觉怎么样呀！','最新更新我的博客，新版感觉怎么样呀！','',2,1322064648,1322064686,NULL,0,0,0,0,0,1,1,0,'我的博客'),(7,1,'<p><a style=\"text-decoration:underline;\" href=\"http://code.google.com/p/ueditor-for-yii/\"><span style=\"font-size:16px\">ueditor-for-yii</span></a></p><div id=\"psum\"><a id=\"project_summary_link\" href=\"http://code.google.com/p/ueditor-for-yii/\">Ueditor是由百度web前端研发部开发的所见即所得富文本web编辑器，开源基于BSD协议。 &nbsp; &nbsp; &nbsp; &nbsp;</a></div><div>最近看到百度开源的一个产品Ueditor 所见即所得富文本web编辑器，感觉很不错，最近又有一个项目，是用YiiFramework 开发的，就把Ueditor 用在这项目里了，于是就把它写成了extensions形式提供给大家下载！yii 地址：<a href=\"http://www.yiiframework.com/extension/ueditor-for-yii/\">http://www.yiiframework.com/extension/ueditor-for-yii/ &nbsp; &nbsp; &nbsp; &nbsp;</a></div><div>由于文件大过2M上传不了到YII官方网站的extensions库里！不一会就好几个差评了！最来就把它上传到谷歌上面了！</div><div>如果有用到的话大家拿去吧！下载地址：<a href=\"http://code.google.com/p/ueditor-for-yii/downloads/list\">http://code.google.com/p/ueditor-for-yii/downloads/list &nbsp; &nbsp; &nbsp; &nbsp;</a></div><div>使用方法：</div><p>…how to use this extension…</p><p>把ueditor插件放到 extensions/ 在Html 调用</p><pre class=\"brush:php;toolbar:false;\">&lt;?php    \r\n    $this-&gt;widget(\'ext.ueditor.Ueditor\',    \r\n            array(    \r\n                \'getId\'=&gt;\'Article_content\',    \r\n                \'textarea\'=&gt;\"Article[content]\",    \r\n                \'imagePath\'=&gt;\'/attachment/ueditor/\',    \r\n                \'UEDITOR_HOME_URL\'=&gt;\'/\',    \r\n            ));    \r\n?&gt;</pre><p>订制Toolbars 方法</p><pre class=\"brush:php;toolbar:false;\">&lt;?php    \r\n    $this-&gt;widget(\'ext.ueditor.Ueditor\',    \r\n            array(    \r\n                \'getId\'=&gt;\'Settings_about\',    \r\n                \'minFrameHeight\'=&gt;180,    \r\n                \'textarea\'=&gt;\"Article[content]\",    \r\n                \'imagePath\'=&gt;\'/attachment/ueditor/\',    \r\n                \'UEDITOR_HOME_URL\'=&gt;\'/\',    \r\n                \'toolbars\'=&gt;\"\'Undo\',\'Redo\',\'ForeColor\', \'BackColor\', \'Bold\',\'Italic\',\'Underline\', \'JustifyLeft\',\'JustifyCenter\',\'JustifyRight\', ,\'InsertImage\',\'ImageNone\',\'ImageLeft\',\'ImageRight\',\'ImageCenter\',\",    \r\n            ));    \r\n?&gt;</pre><p><br /></p><p>关于UEditor</p><p>Ueditor概述 Ueditor是由百度web前端研发部开发的所见即所得富文本web编辑器，具有轻量，可定制，注重用户体验等特点，开源基于BSD协议，允许自由使用和使用代码 为什么使用Ueditor 体积小巧，性能优良，使用简单 分层架构，方便定制与扩展 满足不同层次用户需求，更加适合团队开发 丰富完善的中文文档 多个浏览器支持：Mozilla, MSIE, FireFox?, Maxthon,Safari 和Chrome 更好的使用体验 拥有专业QA团队持续支持，已应用在百度各大产品线上</p><p><br /></p>','Ueditor是由百度web前端研发部开发的所见即所得富文本web编辑器，开源基于BSD协议。</a></div><div>最近看到百度开源的一个产品Ueditor 所见即所得富文本web编辑器，感觉很不错，最近又有一个项目，是用YiiFramework 开发的，就把Ueditor 用在这项目里了，于是就把它写成了extensions形式提供给大家下载！','UEditor',2,1322404562,1342545530,NULL,0,0,0,0,0,1,1,1,'ueditor-for-yii 所见即所得富文本web编辑器'),(8,1,'break-all','Your title here','yii',2,1322580959,1342664214,NULL,0,0,0,0,0,1,1,1,'Your title here'),(24,1,'<p>新增文章归档功能<br /></p><p><span style=\"color:#ffffff;font-family:&#39;helvetica neue&#39;, helvetica, arial, sans-serif;font-size:18px;font-weight:bold;line-height:18px;background-color:#1187dc;\">Archives</span><br /></p>','新增文章归档功能','Archives,文章归档',2,1347253302,1347253302,NULL,0,0,0,0,0,1,1,1,'新增文章归档功能'),(9,1,'Your&nbsp;title&nbsp;here...\r\n==================Y\r\nour&nbsp;title&nbsp;here...\r\n------------------\r\n###&nbsp;Your&nbsp;title&nbsp;here...\r\n###&nbsp;Your&nbsp;title&nbsp;here...\r\n#####&nbsp;Your&nbsp;title&nbsp;here...\r\n######&nbsp;Your&nbsp;title&nbsp;here...\r\n~~~\r\n[php]\r\nYour&nbsp;Code&nbsp;here...\r\n~~~','Your Code here','Your Code here',2,1323511144,1342663980,NULL,0,0,0,0,0,1,1,1,'Your Code here'),(11,1,'Your title here...\r\n==================\r\nYour title here...\r\n------------------\r\n### Your title here...\r\n#### Your title here...\r\n##### Your title here...\r\n###### Your title here...\r\n\r\n','','',2,1323705679,1323705679,NULL,0,0,0,0,0,1,1,0,'标题 cannot be blank. '),(12,1,'<p id=\"initContent\">这在测试中</p><p id=\"initContent\">这在测试中<br /></p><ol style=\"list-style-type:decimal;\"><li><p id=\"initContent\">这在测试中</p></li><li><p id=\"initContent\">这在测试中</p></li><li><p id=\"initContent\">这在测试中</p></li><li><p id=\"initContent\"><span>这在测试中</span><br /></p></li></ol>','test\r\n','test',2,1342540719,1342593593,NULL,0,0,0,0,0,1,1,1,'这在测试中'),(13,1,'<p id=\"initContent\">我要做测试<br /></p><p><strong>我要做测试</strong><br /></p><ol style=\"list-style-type:decimal;\"><li><p><strong>我要做测试</strong></p></li><li><p><strong>我要做测试</strong></p></li><li><p><strong>我要做测试</strong></p></li><li><p><strong>我要做测试<br /></strong></p></li></ol><p><br /></p>','test','test',2,1342540786,1342593609,NULL,0,0,0,0,0,1,1,1,'我要做测试'),(14,1,'<p>it is code </p><p><span style=\"color:#222222;font-family:arial, sans-serif;font-size:13px;font-style:italic;line-height:19px;background-color:#ffffff;\">Ueditor是由百度web前端研发部开发的所见即所得富文本web编辑器，开源基于BSD协议。</span><br /></p><pre class=\"brush:php;toolbar:false;\">&lt;?php\r\n    $this-&gt;widget(\'ext.ueditor.Ueditor\',\r\n            array(\r\n                \'getId\'=&gt;\'Post_content\',\r\n                \'UEDITOR_HOME_URL\'=&gt;\"/\",\r\n                \'options\'=&gt;\'toolbars:[[\"fontfamily\",\"fontsize\",\"forecolor\",\"bold\",\"italic\",\"strikethrough\",\"|\",\r\n\"insertunorderedlist\",\"insertorderedlist\",\"blockquote\",\"|\",\r\n\"link\",\"unlink\",\"highlightcode\",\"|\",\"undo\",\"redo\",\"source\"]],\r\n                    wordCount:false,\r\n                    elementPathEnabled:false,\r\n                    imagePath:\"/attachment/ueditor/\",\r\n                    \',\r\n            ));\r\n?&gt;</pre><p><br /></p>','Ueditor是由百度web前端研发部开发的所见即所得富文本web编辑器，开源基于BSD协议。','php',2,1342541883,1342606184,NULL,0,0,0,0,0,1,1,1,'ueditor-for-yii '),(17,1,'<p>代码如下：</p><p><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\"></span></p><pre class=\"brush:php;toolbar:false;\">&lt;?php\r\nfunction _99 ($n) {\r\nfor ($i=1;$i&lt;=$n;$i++) {\r\necho $i.’*’.$n.’=’.$n*$i.’&amp;nbsp;’;\r\n}\r\necho ‘&lt;br/&gt;’;\r\n$pre = $n – 1;\r\nif ($pre &lt; $n &amp;&amp; $pre &gt; 0) {\r\n_99 ($pre);\r\n}   \r\n}\r\n_99 (9);  \r\n?&gt;</pre><p><span style=\"color:#333333;font-family:georgia, bitstream charter, serif;\"><span style=\"line-height:24px;\"><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\">结果如下：</span><br /></span></span></p><p><span style=\"color:#333333;font-family:georgia, bitstream charter, serif;\"><span style=\"line-height:24px;\"><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\"><br /></span></span></span></p><blockquote><p><span style=\"color:#333333;font-family:georgia, bitstream charter, serif;\"><span style=\"line-height:24px;\"><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\"><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\">1*9=9 2*9=18 3*9=27 4*9=36 5*9=45 6*9=54 7*9=63 8*9=72 9*9=81</span><br style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\" /><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\">1*8=8 2*8=16 3*8=24 4*8=32 5*8=40 6*8=48 7*8=56 8*8=64</span><br style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\" /><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\">1*7=7 2*7=14 3*7=21 4*7=28 5</span><br /></span></span></span></p></blockquote><p><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\"><br /></span></p>','代码如下：','php',2,1342606433,1342606475,NULL,0,0,0,0,0,1,1,2,'php递归实现99乘法表'),(18,1,'<p><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\">1. Nginx配置</span><br style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\" /><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\">在nginx.conf的server {段添加类似如下代码：</span><br style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\" /><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\">Nginx.conf代码:</span><br style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\" /><font color=\"#333333\" face=\"monaco, consolas, andale mono, dejavu sans mono, monospace\" size=\"2\"><span style=\"line-height:24px;\"></span></font></p><pre class=\"brush:bash;toolbar:false;\">location / {\r\nif (!-e $request_filename){\r\nrewrite ^/(.*) /index.php last;\r\n}\r\n}</pre><p><font color=\"#333333\" face=\"monaco, consolas, andale mono, dejavu sans mono, monospace\" size=\"2\"><span style=\"line-height:24px;\"><br style=\"background-color:#FFFFFF;\" /></span></font><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\">2. 在Yii的protected/conf/main.php去掉如下的注释</span><br style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\" /><span style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\">Php代码:</span><br style=\"color:#333333;font-family:georgia, &#39;bitstream charter&#39;, serif;line-height:24px;background-color:#ffffff;\" /><font color=\"#333333\" face=\"monaco, consolas, andale mono, dejavu sans mono, monospace\" size=\"2\"><span style=\"line-height:24px;\"></span></font></p><pre class=\"brush:php;toolbar:false;\">\'urlManager\'=&gt;array(\r\n\'urlFormat\'=&gt;\'path\',\r\n\'rules\'=&gt;array(\r\n\'/\'=&gt;\'/view\',\r\n\'//\'=&gt;\'/\',\r\n\'/\'=&gt;\'/\',\r\n),\r\n),</pre><p><font color=\"#333333\" face=\"monaco, consolas, andale mono, dejavu sans mono, monospace\" size=\"2\"><span style=\"line-height:24px;\"><br /></span></font></p>','Nginx配置','yii',2,1342606936,1342606936,NULL,0,0,0,0,0,1,1,1,'Yii在Nginx下的rewrite配置'),(25,1,'<h2 style=\"margin:0px;color:#555555;font-family:arial, helvetica, sans-serif;background-color:#ffffff;padding-bottom:12px;\">钓鱼岛是中国的</h2><h2 style=\"margin:0px;color:#555555;font-family:arial, helvetica, sans-serif;background-color:#ffffff;padding-bottom:12px;\">钓鱼岛是中国的</h2><h2 style=\"margin:0px;color:#555555;font-family:arial, helvetica, sans-serif;background-color:#ffffff;padding-bottom:12px;\">钓鱼岛是中国的</h2><h2 style=\"margin:0px;color:#555555;font-family:arial, helvetica, sans-serif;background-color:#ffffff;padding-bottom:12px;\">钓鱼岛是中国的</h2><p><br /><br /></p><p><br /></p>','钓鱼岛是中国的','钓鱼岛',2,1347357597,1347357597,NULL,0,0,0,0,0,1,1,1,'钓鱼岛是中国的'),(26,1,'<p>新增皮肤功能</p><p>修改<br />在config/main.php</p><pre class=\"brush:php;toolbar:false;\">\'theme\'=&gt;\'classic\',     //皮肤配置 default为默认或注释掉</pre><p>欢迎大家下载学习。</p><p><a href=\"https://github.com/windsdeng/dlfblog\">https://github.com/windsdeng/dlfblog</a></p><p><br /></p><h2><a name=\"qq交流群\" class=\"anchor\" href=\"https://github.com/windsdeng/dlfblog#qq%E4%BA%A4%E6%B5%81%E7%BE%A4\"></a>QQ交流群</h2><p><code>1、185207750</code></p><p><br /></p><p>有什么建议可以提出来</p><p>所有功能都先是架起一个大至的框架，到时慢慢细致。<br /></p>','新增皮肤功能\r\n有什么建议可以提出来','classic,theme',2,1348392308,1348398138,NULL,0,0,0,0,0,1,1,1,'新增皮肤功能'),(27,1,'<p>sdsfsdgdfg<br /></p>','sdfsdgdfg','',1,1357115018,1369330667,NULL,0,0,0,0,0,1,1,11,'sdfsdf'),(28,1,'<p>fdghfghfghfdg<br /></p>','dsfgdfgfdgh','',2,1357143919,1357143919,NULL,0,0,0,0,0,1,1,1,'edfsdfgsdg'),(29,3,'<p>sdfdsfgdfgdsfg<br /></p>','dsfsdf','',2,1357223912,1357223912,NULL,0,0,0,0,0,1,1,1,'hello'),(30,3,'<p>哈哈哈哈哈哈<br /></p>','测试啦','',1,1367983100,1367983100,NULL,0,0,0,0,0,1,1,1,'fgdg'),(31,3,'<p>heeheheh<br /></p>','sdsdg','Archives, hello,yiqing',1,1367993234,1367993234,NULL,0,0,0,0,0,1,1,1,'testByYiqing95 2'),(32,3,'<p>sdfsdf<br /></p>','dsfgdfg','dfgd,test,hello',1,1367994113,1367994113,NULL,0,0,0,0,0,1,1,1,'shenme a '),(33,3,'<p>thissssssssssssssssssssssssssssssssssssssssssssssssssssssss<br /></p><p>thissssssssssssssssssssssssssssssssssssssssssssssssssssssss<br /></p><p>thissssssssssssssssssssssssssssssssssssssssssssssssssssssss<br /></p><p>thissssssssssssssssssssssssssssssssssssssssssssssssssssssss<br /></p><p><br /></p>','蛋疼的啊','',1,1368031991,1368031991,NULL,0,0,0,0,0,1,1,2,'shehh'),(34,3,'<p>到房管局劳动法看几个看 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br /></p>','生','',1,1368032688,1368032688,NULL,0,0,0,0,0,1,1,1,'刀剑如梦=345'),(35,2,'<p>sdfsdfg<br /></p>','sdgdfg','',1,1368116939,1368116939,NULL,0,0,0,0,0,1,1,1,'teww'),(36,2,'<p>sdfsdgdf<br /></p>','sdgdfg','',1,1368117488,1368117488,NULL,0,0,0,0,0,1,1,1,'sdfsdf'),(37,2,'<p>是打发第三方<br /></p>','加加减减','',1,1368150942,1368150942,NULL,0,0,0,0,0,1,1,1,'电饭锅'),(38,2,'<p>sd敢达双方各电饭锅<br /></p>','是打发第三方给','',1,1368153754,1368153754,NULL,0,0,0,0,0,1,1,6,'蛇呵呵呵'),(39,2,'<p>送电饭锅第三方给<br /></p>','撒旦个的双方各','',1,1368154967,1368154967,NULL,0,0,0,0,0,1,1,6,'撒剪短发卡萨丁'),(40,2,'<p>撒旦嘎斯电饭锅<br /></p>','撒电饭锅','',1,1368155244,1368155244,NULL,0,0,0,0,0,1,1,0,'说地方撒旦'),(41,2,'<p>阿斯顿个飞洒 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br /></p>','阿斯顿个第三个','',1,1368155651,1368155651,NULL,0,0,0,0,0,1,1,0,'是大家发顺丰'),(42,1,'<p>撒旦郭殿方<br /></p>','多个','',1,1368156337,1368156337,NULL,0,0,0,0,0,1,1,9,'说地方撒旦'),(43,2,'<p>sdfsdgdfg<br /></p>','dfgdsfgdsf','',2,1368160052,1368160052,NULL,0,0,0,0,0,1,1,0,'sdfsajdkfjk'),(44,3,'<p>撒打发<br /></p>','是打发斯蒂芬','',1,1368294485,1368294485,NULL,0,0,0,0,0,1,1,12,'收到发送到'),(45,3,'<p>撒旦嘎斯电饭锅 <br /></p>','撒旦法撒旦个','',2,1368294572,1368294572,NULL,0,0,0,0,0,1,1,12,'说地方撒旦'),(46,2,'<p>但神风怪盗东方红<br /></p>','撒大幅度','',1,1368326791,1368326791,NULL,0,0,0,0,0,1,1,29,'收到发送到'),(47,1,'<p>随碟附送大概电饭锅<br /></p>','斯蒂芬','',1,1368363029,1368363722,NULL,0,0,0,0,0,1,1,11,'的所发生的'),(48,3,'<p>送大幅度覆盖电饭锅<br /></p>','速度飞洒地方给','',1,1368687666,1368687666,NULL,0,0,0,0,0,1,1,31,'收到发送到'),(49,2,'<p>jhlkjhlkjhlkjhkl<br /></p>','bgfjhgfhjgfhjgfjhgfjhg','',1,1368719504,1368719504,NULL,0,0,0,0,0,1,1,6,'uuuu'),(50,2,'<p>asgdsfgdsfhg<br /></p>','dfhfgh','',1,1368757048,1368757048,NULL,0,0,0,0,0,1,1,6,'sadfsdfgdsf'),(51,2,'<p>sadgdsfg<br /></p>','sdfgdsfhg','',1,1368758141,1368758141,NULL,0,0,0,0,0,1,1,6,'sdfasd'),(52,2,'<p>sadgsdfhg<br /></p>','sadgdfgdfg','',1,1368759650,1368759650,NULL,0,0,0,0,0,1,1,17,'sadffsdfg'),(53,2,'<p>dfgdsfghdsfh<br /></p>','sdfgdfh','',1,1368759738,1368759738,NULL,0,0,0,0,0,1,1,6,'sdfsadg'),(54,2,'<p>dfhdsfhfgh<br /></p>','asdfgfgh','',1,1368759794,1368759794,NULL,0,0,0,0,0,1,1,6,'sdgdsafg'),(55,2,'<p>撒打发呵呵呵呵<br /></p>','省心 吧','',1,1368759836,1368759836,NULL,0,0,0,0,0,1,1,6,'认真的标题啊'),(56,2,'<p>撒旦郭殿方<br /></p>','撒旦郭殿方 ','',1,1368761209,1368761209,NULL,0,0,0,0,0,1,1,6,'撒旦法撒旦个是'),(57,3,'<p>哈哈水电费和<br /></p>','撒旦法撒旦个','',1,1368761305,1368761305,NULL,0,0,0,0,0,1,1,12,'什么情况'),(58,1,'<p>与图腾<br /></p>','快交换机','',1,1368762129,1368762129,NULL,0,0,0,0,0,1,1,9,'急急急'),(59,1,'<p>撒旦发送到</p>','撒打发','',1,1368765491,1368765491,NULL,0,0,0,0,0,1,1,9,'撒打发'),(60,1,'<p>阿斯顿嘎斯<br /></p>','说但发鬼地方','',1,1368766172,1368766172,NULL,0,0,0,0,0,1,1,9,'速度飞洒地方'),(61,1,'<p>的发送到</p>','电饭锅','',1,1368766643,1368766643,NULL,0,0,0,0,0,1,1,9,'撒旦个电饭锅'),(62,1,'<p>是打发斯蒂芬<br /></p>','十多个','',1,1368769360,1368769360,NULL,0,0,0,0,0,1,1,9,'是打发斯蒂芬'),(63,1,'<p>撒旦发送到<br /></p>','撒旦发送到','',1,1368769702,1368769702,NULL,0,0,0,0,0,1,1,9,'撒旦发送到'),(64,1,'<p>sdfgdfghdfhfgh<br /></p>','sdfsadg','',1,1368896342,1368896342,NULL,0,0,0,0,0,1,1,9,'sdfsadg'),(65,3,'<p>撒打发送电饭锅第三方给电饭锅<br /></p>','打底衫','',1,1368981449,1368981449,NULL,0,0,0,0,0,1,1,12,'撒旦发送到'),(66,1,'<p>说地方撒旦<br /></p>','盛大富翁 ','',1,1369240440,1369240441,NULL,0,0,0,0,0,1,1,9,'速度飞洒地方'),(67,1,'<p>说地方撒旦<br /></p>','随碟附送','',1,1369240535,1369240535,NULL,0,0,0,0,0,1,1,9,'说地方撒旦'),(68,1,'<p>个发速度飞洒地方<br /></p>','说地方撒旦','',1,1369240637,1369240637,NULL,0,0,0,0,0,1,1,9,'说地方撒旦'),(69,1,'<p>说地方撒旦速度飞洒地方<br /></p>','随碟附送','',1,1369240938,1369241812,NULL,0,0,0,0,0,1,1,9,'说地方撒旦'),(70,1,'<p>sdgdfg<br /></p>','sdgdfg','',1,1369323185,1369323185,NULL,0,0,0,0,0,1,1,9,'tewst'),(71,1,'<p>撒的发生连快递费<br /></p>','撒打发','yii, pp,单独',1,1369330770,1369330770,NULL,0,0,0,0,0,1,1,32,'标题'),(77,3,'<p>墨迹安排 &nbsp;什么情况 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br /></p>','总结下啊 a','',1,1372265418,1372265418,NULL,0,0,0,0,0,1,1,33,'吉安帕');
