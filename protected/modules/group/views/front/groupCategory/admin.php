...
<?php	 Yii::app()->clientScript->registerScriptFile(bu('public/js/backend/admin.js')); ?>
...
<?php  $dataProvider = $model->search();
        ...
        $this->widget('my.widgets.TbColumnView', array(
                'id'=>'group-category-items-view', // same as grid view
                'dataProvider' => $dataProvider,
