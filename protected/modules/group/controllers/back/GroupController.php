...
class GroupController extends BackendController
{
     ...
     *  ajaxCreate functionality is almost using the same code (just change the $this->loadModel($id) to new Group)
     */
