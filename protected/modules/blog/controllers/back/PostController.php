...
class PostController extends BackendController
{
     ...
     *  ajaxCreate functionality is almost using the same code (just change the $this->loadModel($id) to new Post)
     */
	...
	public function actionAdmin()
	{
        ...
        $criteria->select = 't.*, br.grade as recommendGrade , br.id as recommendId ';
        $criteria->join = 'LEFT JOIN blog_recommend br ON br.object_id = t.id';


        if(isset($model->recommendGrade)){
            $criteria->compare('br.grade','>0');
        }
