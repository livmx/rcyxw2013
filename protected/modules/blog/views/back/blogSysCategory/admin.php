...
<h1>Manage Blog Sys Categories</h1>
...
<?php  $dataProvider = $model->search();
        ...
        $this->widget('my.widgets.TbColumnView', array(
                'id'=>'blog-sys-category-items-view', // same as grid view
                'dataProvider' => $dataProvider,
