 ...
 */
class JExposure extends CWidget
{
    ...
    public function init()
    {
        ...
        if ($this->debug) {
            ...
            $this->registerScriptFile('jquery.exposure.js', CClientScript::POS_HEAD);

        } else {
            // no the min file now !
            $this->registerScriptFile('jquery.exposure.min.js', CClientScript::POS_HEAD);
        }
