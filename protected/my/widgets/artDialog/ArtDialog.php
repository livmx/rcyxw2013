...
class ArtDialog  extends CWidget
{
    ...
    public function init()
    {
        ...
        $this->publishAssets();
        if ($this->debug) {
            $this->registerScriptFile('source/jquery.artDialog.js', CClientScript::POS_HEAD);
        } else {
            $this->registerScriptFile('jquery.artDialog.min.js', CClientScript::POS_HEAD);
        }
        $this->registerScriptFile('artDialog.plugins.min.js', CClientScript::POS_HEAD);

        $skinBaseUrl = $this->baseUrl.'/skins';

        $artDialogSkin =<<<SKIN
<!--[if gte IE 7]><!-->
    <link id="artDialog-skin" href="{$skinBaseUrl}/{$this->skin}.css" rel="stylesheet" />
<!--<![endif]-->
<!--[if lt IE 7]>
    <link id="artDialog-skin" href="{$skinBaseUrl}/default.css" rel="stylesheet" />
<![endif]-->
SKIN;
