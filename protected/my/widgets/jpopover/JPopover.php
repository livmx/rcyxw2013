...
class JPopover extends CWidget
{
    ...
    public function init()
    {
        ...
        $this->registerCssFile($this->debug ? 'popover.css': 'pop0.css');

        if ($this->debug) {
            $this->registerScriptFile('jquery.popover-1.1.2.js', CClientScript::POS_HEAD);
        } else {
            $this->registerScriptFile('jquery.popover-1.1.2.js', CClientScript::POS_HEAD);
        }
