...
<div class="form">
    ...
    <table>
        ...
        <tr>
            ...
            <?php if (!$column->autoIncrement): ?>
                <td>
                    <?php  $inputPhp = "<?php echo CHtml::activeTextField(\$item,\"[\$i]{$column->name}\"); ?>";
    ...
    <?php echo "<?php"; ?> echo CHtml::hiddenField('ids', $_POST['ids'], array('class' => 'batch-op-targets')); ?>

    <?php $submitButton = "<?php echo CHtml::submitButton('Save',array('name'=>'submit'));// must give the submit button a name to identify its request source ?>";?>
