...
<?php echo "<?php"; ?> $this->widget('wij.WijTabs', array(
...
$this->widget('ext.PageSize.EPageSize', array(
        $XViewName => '<?php echo $this->class2id($this->modelClass); ?>-grid',
...
<?php echo "<?php"; ?> echo CHtml::beginForm($this->createUrl('batchOperation'),'post',array('id'=>'batchOpForm')); ?>

<?php echo "<?php \$this->renderPartial(\$viewStyles[\$requestViewStyle],array(
    'model'=>\$model,
...
<div class="alert alert-info">
    <div class="row-fluid">
        <div class="span2">
            <?php echo "<?php"; ?> echo CHtml::hiddenField('items', '', array('class' => 'batch-op-targets')); ?>
            <?php echo "<?php"; ?>
