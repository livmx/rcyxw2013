...
insert  into `blog_category`(`id`,`uid`,`pid`,`name`,`alias`,`position`,`mbr_count`) values (1,0,0,'yii','yii',0,19),(2,0,0,'php','php',0,2),(6,2,0,'心情','',0,2),(9,1,0,'我的分类啊','',0,1),(10,1,0,'wo quee','',0,0),(11,1,0,'我去2','',0,1),(12,3,0,'看不见哎','',0,2),(13,3,0,'是打发斯蒂芬','',0,0),(15,2,0,'第三方撒旦','',0,0),(16,2,0,'你好','',0,0),(17,2,0,'速度飞洒地方','',0,0),(28,2,0,'好啊','',0,0),(29,2,0,'我去','',0,1),(30,1,0,'阿斯蒂芬克束带结发','',0,1);
...
insert  into `blog_tag`(`id`,`name`,`frequency`) values (1,'yii',3),(2,'blog',1),(3,'test',4),(6,'UEditor',1),(7,'php',2),(14,'classic',1),(11,'Archives',2),(12,'文章归档',1),(13,'钓鱼岛',1),(15,'theme',1),(16,'hello',2),(17,'yiqing',1),(18,'dfgd',1);
...
insert  into `notice_category`(`id`,`name`,`order`,`enable`) values (2,'notice2',3,1),(3,'ddd',7,1),(4,'yes',5,1),(5,'heee',1,1);
...
insert  into `status_link`(`id`,`url`,`description`) values (33,'http://stackoverflow.com/questions/3433391/how-to-restrict-user-not-to-vote-an-article-more-than-once','禁止多次投票'),(54,'',''),(69,'http://www.nofilm.cn/user/portal.html','一个yii开发的网站呢'),(72,'www.baidu.com','baidu'),(73,'http://www.baidu.com','this is baidu home page ');
...
insert  into `user`(`id`,`username`,`password`,`icon_uri`,`email`,`activkey`,`superuser`,`status`,`create_at`,`lastvisit_at`) values (1,'yiqing','32ee7d239bcc2eff68f47ca70bd6e4a7','uploads/user/13678133261367813326.jpg','webmaster@example.com','8abda1b47ccc436c2aaf3eb5912d3971',1,1,'2012-07-24 15:46:36','2013-05-12 13:16:23'),(2,'yiqing2','32ee7d239bcc2eff68f47ca70bd6e4a7','uploads/user/13676024711367602471.jpg','66104992@qq.com','c1a5a5f7d1cc198d132d2d367ca08877',0,1,'2012-07-27 10:29:01','2013-05-06 03:31:06'),(3,'yiqing3','32ee7d239bcc2eff68f47ca70bd6e4a7','uploads/user/13679859491367985949.jpg','yiqing_95@qq.com','f07550b610f3388b17ffc6b62aecb1ad',0,1,'2012-08-11 14:15:02','2013-05-09 15:12:49'),(4,'tewt','test',NULL,'ceshi@qq.com','',0,0,'2013-03-24 18:53:49','0000-00-00 00:00:00');
...
CREATE TABLE `user_space_visit_stat` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8301 DEFAULT CHARSET=utf8 COMMENT='空间访问量日统计';

/*Data for the table `user_space_visit_stat` */

insert  into `user_space_visit_stat`(`id`,`target`,`day`,`times`) values (8274,1,'2013-04-26',4),(8275,2,'2013-04-26',3),(8276,1,'2013-04-27',6),(8277,1,'2013-04-28',1),(8278,1,'2013-04-29',2),(8279,1,'2013-04-30',1),(8280,1,'2013-05-01',1),(8281,1,'2013-05-02',1),(8282,2,'2013-05-03',1),(8283,3,'2013-05-03',1),(8284,2,'2013-05-06',1),(8285,3,'2013-05-06',1),(8286,1,'2013-05-06',1),(8287,1,'2013-05-07',2),(8288,3,'2013-05-07',2),(8289,2,'2013-05-08',1),(8290,1,'2013-05-08',1),(8291,1,'2013-05-09',1),(8292,3,'2013-05-09',1),(8293,2,'2013-05-09',1),(8294,1,'2013-05-10',1),(8295,2,'2013-05-10',2),(8296,3,'2013-05-10',2),(8297,1,'2013-05-11',1),(8298,1,'2013-05-12',1),(8299,1,'2013-05-15',1),(8300,3,'2013-05-15',1);
...
insert  into `user_space_visitor`(`space_id`,`visitor_id`,`vtime`) values (1,2,1368156103),(1,3,1367985971),(2,1,1367813349),(2,3,1368294627),(3,1,1368585644),(3,2,1368156222);
...
insert  into `yiisession`(`id`,`expire`,`data`,`user_id`) values ('ivvf1jpqpr1uqgkn7gsa8ht076',1368605787,'',0);
